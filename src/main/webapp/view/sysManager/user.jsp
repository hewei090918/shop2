  ...
  <body>
    <div class="panel panel-default">
    	<div class="panel-body" style="padding-bottom:0px;">
	    	<form class="form-horizontal" id="user_search_form">
	    		<div class="row">
	                 ...
	                 <div class="col-sm-3 col-md-3">
	                     <div class="form-group">
	                         ...
	                         <div class="col-sm-8">
	                         	...
	                         	<input type="text" class="form-control" name="deptName" id="deptSelect" style="height:28px;" data-toggle="modal" data-target="#deptSelect_modal" readonly>
	                         </div>
	                     </div>
	                 </div>
	                 <div class="col-sm-3 col-md-3">
    	...
    	<div id="user_toolbar" class="btn-group" style="padding:0px 15px;">
            <button id="btn_user_query" type="button" class="btn btn-default">
               <span class="glyphicon glyphicon-search" aria-hidden="true"></span> 查询
            </button>
            <button id="btn_user_reset" type="button" class="btn btn-default">
               <span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> 重置
            </button>
            <button id="btn_user_add" type="button" class="btn btn-default">
               <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 新增
            </button>
            <button id="btn_user_delete" type="button" class="btn btn-default">
               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 删除
            </button>
        </div>
        
        <div class="panel-body" style="padding:0px;">
	        <table id="userList_table" class="table table-hover table-striped table-bordered" data-toggle="table">
			</table>
        </div>
            ...
            <div class="modal-dialog" style="width:400px">
                <div class="modal-content">
		            ...
		            <div class="modal-body">
		            	<div id="deptTree" style="height:250px;overflow:auto;"></div>
		            </div>
